...
internal class EOIcoCurLoader
{
  ...
  private struct IcoHeader
  {
    ...
    public static int GetStructSize() => sizeof (EOIcoCurLoader.IcoHeader);
  ...
  private struct DirectoryEntry
  {
    ...
    public static int GetStructSize() => sizeof (EOIcoCurLoader.DirectoryEntry);
  ...
  private struct BITMAPINFOHEADER
  {
    ...
    public BITMAPINFOHEADER(int width, int height, int bpp)
    {
    ...
    public static int GetStructSize() => sizeof (EOIcoCurLoader.BITMAPINFOHEADER);
