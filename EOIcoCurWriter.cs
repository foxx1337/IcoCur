...
internal class EOIcoCurWriter
{
  ...
  private struct IcoHeader
  {
    ...
    public static int GetStructSize() => sizeof (EOIcoCurWriter.IcoHeader);
  ...
  private struct DirectoryEntry
  {
    ...
    public static int GetStructSize() => sizeof (EOIcoCurWriter.DirectoryEntry);
  ...
  private struct BITMAPINFOHEADER
  {
    ...
    public static int GetStructSize() => sizeof (EOIcoCurWriter.BITMAPINFOHEADER);
